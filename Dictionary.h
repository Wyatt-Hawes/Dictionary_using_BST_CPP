...
private:
   ...
   void inOrderString(std::ostream& output, Node* R) const;
   ...
   void preOrderString(std::ostream& output, Node* R) const;
   ...
   // Checks if node is a nil node
   bool is_null(Node* R) const;
   ...
   Node* contains_node(keyType k) const;
public:
